						...
						<svg width="135px" height="29px" viewBox="0 0 155 29" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" font-size="40" font-family="AustinBold, Austin" font-weight="bold">
						        <g id="Group" transform="translate(-108.000000, -297.000000)" fill="#000000">
						        	<a id="AVIATO" class="navbar-brand" href="#"><img src="images/header-logo.png" alt=""></a>
						        </g>
						    </g>
						</svg>
					</a>
	            ...
	            <div class="dropdown-menu cart-dropdown">
	            	...
	            	<div class="media">
	            		...
	            		<div class="media-body">
	            			<h4 class="media-heading"><a href="">Bracelet</a></h4>
	            			<div class="cart-price">
                              <span>1 x</span>
                              <span>125.00</span>
                            </div>
                            <h5><strong>$125</strong></h5>
	            		</div>
	            	...
	            	<div class="cart-summary">
                        <span>Total</span>
                        <span class="total-price">$195.00</span>
                    </div>
                    <ul class="text-center cart-buttons">
                    	<li><a href="" class="btn btn-small btn-solid-border">View Cart</a></li>
	      ...
	      <div id="navbar" class="navbar-collapse collapse text-center">
	        <ul class="nav navbar-nav">
	          ...
	          <li class="dropdown dropdown-slide">
	            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">About Us <span class="tf-ion-ios-arrow-down"></span></a>
	            <ul class="dropdown-menu">
	            	
					<li><a href="aboutus.html">ROYAL JEWELRY</a></li>
					<li><a href="FAQ.html">FAQ</a></li>
					<li><a href="Developer.html">Developers</a></li>
					<li><a href="https://www.swarovski.com/en-US/">Other ROYAL JEWELRY sites</a></li>
	            </ul>
	          </li><!-- / Blog -->
...
<div class="home-slider">
 	<div>
  	...
  	<div>
  		<div class="slider-item dark-bg" style="background-image:url('images/slider/slider-2.jpg')">
			<div class="container">
  	...
  	<div>
  		<div class="slider-item dark-bg" style="background-image:url('images/slider/slider-3.jpg'); background-position:50%;background-repeat:no-repeat;">
			<div class="container">
				<div class="slide-inner text-left">
					<h1>Bracelet</h1>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">AAAAAAA</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">BBBBBB</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">CCCCCC</a></h4>
						<p class="price">$230</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">DDDDDDD</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">EEEEEEEE</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">FFFFFFF</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">GGGGGGG</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">HHHHHHHHH</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						<h4><a href="product-single.html">JJJJJJJ</a></h4>
						<p class="price">$200</p>
					</div>
				</div>
			</div>
			        	...
			        	<div class="row">
			        		...
			        		<div class="col-md-4 col-sm-6 col-xs-12">
			        			<div class="product-short-details">
			        				<h2 class="product-title">AAAAAAAA</h2>
			        				<p class="product-price">$200</p>
			        				<p class="product-short-description">
			        					XXXXXXXXXXXXXXXXXX<br>XXXXXXXXXXXXX.
			        				</p>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="title">
					...
					<p>Exclusive ROYAL JEWELRY offers are only a text away</p>
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="copyright-text">Copyright © 2019 ROYAL JEWELRY. All rights reserved <br> Designed by Yao Li AAA BBB </p>
			</div>
		</div>
	</div>
</footer>

<a class="btn btn--success btn--floating box-shadow-wide" target="_blank" href="#">
